...
const cartSchema = new mongoose.Schema({
  products: [
    {
      // aca creamos una referencia a nuestro schema de Producto. mongoose con esto sabe que el carrito va a tener productos creados con el cartSchema permitiendonos acceder a metodos especiales como el populate
